...
public class SlackClient {
  ...
  private static final String AUTHOR_NAME = "Muhammad Nur";
  private static final String SLACK_CHANNEL = "#web-automation";
  ...
  public static Response sendSlackNotifications(int passTests, int failedTests) {
    ...
    String url = "https://hooks.slack.com/services/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";
    String tags = "@Test";
